...
export const SWISS_CONFIG: BracketConfig = {
  ...
  height: 840,
  nodes: [
    { id: "g00", x: 90, y: 420, type: "swissGroup", score: "0:0", count: 8 },
    { id: "g10", x: 280, y: 276, type: "swissGroup", score: "1:0", count: 4 },
    { id: "g01", x: 280, y: 564, type: "swissGroup", score: "0:1", count: 4 },
    { id: "g20", x: 470, y: 186, type: "swissGroup", score: "2:0", count: 2 },
    { id: "g11", x: 470, y: 420, type: "swissGroup", score: "1:1", count: 4 },
    { id: "g02", x: 470, y: 654, type: "swissGroup", score: "0:2", count: 2 },
    { id: "g30", x: 660, y: 111, type: "swissResult", score: "3:0", count: 2, win: true },
    { id: "g21", x: 660, y: 308, type: "swissGroup", score: "2:1", count: 3 },
    { id: "g12", x: 660, y: 532, type: "swissGroup", score: "1:2", count: 3 },
    { id: "g03", x: 660, y: 729, type: "swissResult", score: "0:3", count: 2, win: false },
    { id: "g31", x: 850, y: 186, type: "swissResult", score: "3:1", count: 3, win: true },
    { id: "g22", x: 850, y: 420, type: "swissGroup", score: "2:2", count: 3 },
    { id: "g13", x: 850, y: 654, type: "swissResult", score: "1:3", count: 3, win: false },
    { id: "g32", x: 1040, y: 303, type: "swissResult", score: "3:2", count: 3, win: true },
    { id: "g23", x: 1040, y: 537, type: "swissResult", score: "2:3", count: 3, win: false },
  ],
  edges: [
