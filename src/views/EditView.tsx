...
export const EditView: React.FC<EditViewProps> = ({
  ...
  handleSavePick, activeStage, setActiveStage,
  picks, setPicks, defaultPicks,
  currentSlots,
  showResults, setShowResults,
  mobileView, setMobileView,
  getStageStatus, currentPoolTeams, selectedTeamId, setSelectedTeamId,
  handleDrop, handleAssignSlot, handleClear, checkPrediction, activeStageActuals, getSetStatus
}) => {
  return (
    <>
      {/* Left Sidebar */}
