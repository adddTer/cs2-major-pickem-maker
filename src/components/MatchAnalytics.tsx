              ...
              {powerAverages.map((cat: any, i: number) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="w-1.5 relative border border-white/5 bg-zinc-800 rounded-full h-[36px] overflow-hidden">
                      <div
                        className={cn(
                    ...
                    <div className="text-[10px] text-zinc-400 my-0.5">
                      {cat.name}
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {prStats.map((statItem: any, idx: number) => {
              ...
              return (
                <div
                  key={idx}
                  className="bg-zinc-900/80 border border-white/5 rounded-xl p-3 flex flex-col gap-3 relative overflow-hidden"
                >
                  <div className="text-[13px] font-bold text-center text-zinc-200">
                    {statItem.title}
                  </div>
                  <div className="flex justify-between items-stretch w-full relative">
                    ...
                    <div className="flex flex-col items-center flex-1 relative px-1">
                      <div className="relative mb-2">
                        <div className="w-12 h-12 bg-zinc-800 rounded-full overflow-hidden border border-white/10 flex items-center justify-center">
                      ...
                      <div className="text-[10px] font-bold text-white mb-2 max-w-[80px] truncate">
                    ...
                    {/* Divider Line */}
                    <div className="w-px h-[calc(100%-10px)] bg-white/5 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2" />
