...
export const PickSetStatusText = ({ statusData, showProbability = false }: { statusData: any, showProbability?: boolean }) => {
    if (!statusData) return null;
    const { statusId, guaranteed, mathematicallyIncorrect, passingProbability } = statusData;
