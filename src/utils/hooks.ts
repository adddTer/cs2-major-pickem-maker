...
import { Trophy, RefreshCw, Clock, Users, Edit3, CheckCircle2, Home, Plus, XCircle } from 'lucide-react';
import { TeamLogo } from '../components/TeamLogo';

export const useFitScale = (intrinsicWidth: number, intrinsicHeight: number) => {
